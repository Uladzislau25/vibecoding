      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/80 dark:border-gray-700/80 shadow-sm overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody>
              ...
              >
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center gap-2">
                    <span
                      className={`inline-flex items-center px-2 py-0.5 rounded text-[11px] font-medium border ${ROLE_COLORS[u.role] ?? ROLE_COLORS.user}`}
                    >
            ...
            {users.length === 0 && (
              <tr>
                <td colSpan={3} className="px-4 py-12 text-center text-gray-400 dark:text-gray-500 text-sm">
