...
import { getRecipesForPicker } from "@/app/actions";
    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/40 backdrop-blur-sm" onClick={() => setOpen(false)}>
          <div
            className="w-full sm:max-w-md bg-white dark:bg-gray-900 rounded-t-2xl sm:rounded-2xl border border-gray-200 dark:border-gray-700 shadow-xl flex flex-col max-h-[70vh]"
            ...
            <div className="overflow-y-auto flex-1">
              ...
              {recipes.map((r) => (
                <button
                  ...
                  className="w-full flex items-center justify-between gap-3 px-4 py-3 text-left hover:bg-gray-50 dark:hover:bg-gray-800/60 transition-colors border-b border-gray-50 dark:border-gray-800 last:border-0 disabled:opacity-50"
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    {sentId === r.id ? (
                      ...
                      <span className="text-xs text-blue-500">Отправить</span>
                    )}
                  </div>
                </button>
              ))}
